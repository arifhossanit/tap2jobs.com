...
return [
    ...
    */
    ...
    'view_details' => '查看详情',
    'resume_id_required' => '简历字段是必填的。',
    'password_mismatch' => '密码和确认密码必须匹配',
    'image_required' => '图片字段是必填的。',
    'country_id_required' => '国家字段是必填的。',
    'image_type' => '图片必须是 jpeg、jpg 或 png 文件类型。',
    'iso_code_required' => 'ISO 代码字段是必填的。',
    'employer_details_required' => '雇主详情是必填的',
    'employer_name' => '雇主名称是必填的。',
    'state_required' => '州字段是必填的。',
    'terms_and_conditions_required' => '您必须同意条款和条件。',
    ...
    'phone_number' => '输入电话号码',
    'account_password' => '设置账户密码',
    'confirm_account_password' => '确认账户密码',
    'your_email' => '您的电子邮件',
    'enter_your_email' => '输入您的电子邮件',
    'your_password' => '您的密码',
    'min' => '最小',
    'max' => '最大',
    'password_reset' => '点击这里重置密码',
    'reset_password' => '重置密码',
    'enter_email_reset_password' => '输入您的电子邮件以重置密码',
    'new_password' => '设置新密码',
    'admin_login' => '管理员登录',
    'super_admin_login' => '超级管理员登录',
    'candidate_login' => '候选人登录',
    'employer_login' => '雇主登录',
    'front_site' => '前端页面',
    'sign_in' => '登录',
    ...
    'processing' => '处理中...',
    'pdf' => 'PDF',
    'not_immediate_available' => '暂时不可用',
    'immediate_available' => '立即可用',
    'something_missing' => '对不起！缺少一些内容...',
    'page_not_found' => '您访问的页面不可用 / 不存在 / 加载不正确',
    'go_back' => '返回上一页',
    'company_subscription' => '公司订阅',
    'select_status' => '选择状态',
    'select_featured_job' => '选择推荐职位',
    'select_featured_company' => '选择推荐公司',
    'is_suspended' => '已暂停',
    'is_freelance' => '自由职业',
    'select_job_status' => '选择职位状态',
    'yes' => '是',
    'no' => '否',
    'drafted' => '草稿',
    'live' => '在线',
    ...
    'setting' => [
        ...
        'company_description_required' => '公司描述为必填项',
        'company_url_required' => '公司网址为必填项',
    ...
    'marital_status' => [
        ...
        'marital_status_cant_delete' => '婚姻状况不能被删除',
    ],
    ...
    'language' => [
        ...
        'language_cant_delete' => '语言不能被删除',
        'language_not_deleted' => '语言未被删除',
    ],
    ...
    'flash' => [
        'pending_manual_purchase' => '您的手动交易请求正在等待中。',
        ...
        'job_draft' => '工作草稿保存成功。',
        'job_save' => '作业保存成功。',
        'job_save_pending_approval' => '职位已成功提交。管理员团队将在 24 小时内审核并批准。',
        'job_not_found' => '找不到工作。',
        ...
        'this_currency_is_not' => 'PayStack 不支持此货币进行付款。',
        ...
        'key_responsibilities_required' => '主要职责字段为必填项',
        ...
        'verify_email' => '请验证您的电子邮件地址。',
        'account_not_active' => '您的账户尚未激活。请联系管理员。',
    ...
    'pending_jobs' => [
        ...
        'closed' => '已关闭',
        'pending' => '待处理',
        'successfully_accepted' => '职位已成功接受。',
        'successfully_reject' => '职位已成功拒绝。',
        'reason' => '原因',
        'suspended' => '暫停',
        'unlimited_plan' => '無限制計劃',
    ],
];
