...
return [
    ...
    'resume_id_required' => 'The Resume Field is Required.',
    'password_mismatch' => 'The password and confirm password must match',
    'image_required' => 'The image field is required.',
    'country_id_required' => 'The country field is required.',
    'image_type' => 'The image must be a file of type: jpeg, jpg, png.',
    'iso_code_required' => 'The ISO Code field is required.',
    'employer_details_required' => 'Employer Details is required',
    'employer_name' => 'The Employer Name is required.',
    'state_required' => 'The state field is required.',
    'terms_and_conditions_required' => 'You must agreed to Terms and conditions.',
    ...
    'account_password' => 'Set Account Password',
    ...
    'resetresources/views/candidate/layouts/app.blade.php_password' => 'Reset Password',
    ...
    'something_missing' => 'Opps! Something\'s missing...',
    'page_not_found' => 'The page you are looking for doesn\'t exists / isn\'t available / was loading incorrectly',
    ...
    'common' => [
        ...
        'remove_application_confirmation' => 'Remove this application from your list?',
        'action' => 'Action',
        'name' => 'Name',
        'reset' => 'Reset',
    ...
    'setting' => [
        ...
        'company_url_required' => 'Company URL is required',
    ...
    'marital_status' => [
        ...
        'marital_status_cant_delete' => 'Marital Status can\'t be deleted',
    ],
    'salary_period' => [
    ...
    'language' => [
        ...
        'language_cant_delete' => 'Language can\'t be deleted.',
    ...
    'user' => [
        ...
        'password_length_hint' => '6-20 characters.',
        'passwords_do_not_match' => 'Passwords do not match.',
        'passwords_match' => 'Passwords match.',
        'password_checklist' => 'Password checklist',
        'fresh_password' => 'Use a fresh password',
        'fresh_password_hint' => 'Avoid using a password from another account.',
        'memorable_password' => 'Keep it memorable',
        'memorable_password_hint' => 'A short phrase with numbers works well.',
        'confirm_password_carefully' => 'Confirm carefully',
        'confirm_password_carefully_hint' => 'Both new password fields must match.',
    ],
    'salary_currency' => [
    ...
    'job' => [
        ...
        'job_title' => 'Job Title',
        'employment_status' => 'Job Nature',
        'employment_type' => 'Job Nature',
        'workplace' => 'Workplace',
        'full_time' => 'Full Time',
        'part_time' => 'Part Time',
        ...
        'experience_range_placeholder' => 'e.g. 1-2 or 6 months - 1 year',
        'freshers_encouraged' => 'Freshers also encourage to apply',
        'fresher_jobs' => "Fresher's Jobs",
        'fresher_jobs_hint' => 'Show jobs that welcome fresh candidates',
        'salary_range' => 'Salary Range',
        'maximum_experience' => 'Experience Range (Years)',
        'year' => 'Year',
        'years' => 'Years',
        'month' => 'Month',
        'months' => 'Months',
        'experience_duration_required' => 'Enter at least one month of experience or select Fresher.',
        'is_freelance' => 'Is Freelance',
        'hide_salary' => 'Negotiable',
        'is_featured' => 'Is Featured',
        'is_suspended' => 'Is Suspended',
        'job_skill' => 'Job Skill',
        'country' => 'Country',
        ...
        'no_applied_job_found' => 'No Job Available',
    ...
    'candidate_dashboard' => [
        ...
        'sections_completed' => ':completed of :total sections completed',
        'profile_scoring_breakdown' => 'Profile scoring breakdown',
        'profile_scoring_summary' => ':percentage% profile completed from :total scoring areas.',
        'edit_profile' => 'Edit profile',
        'matching_jobs' => 'Matching Jobs',
        'view_more_jobs' => 'View More',
        'view_all_jobs' => 'View All Jobs',
        'view_details' => 'View Details',
        'no_matching_jobs_found' => 'No matching jobs found',
        'complete_profile_for_recommendations' => 'Complete your skills, preferred area and location to get better recommendations.',
    ...
    'candidate_profile' => [
        ...
        'training_not_found' => 'No Training Available.',
        'certification_not_found' => 'No Professional Certification Available.',
        'skill_not_found' => 'No Skill Available.',
        'extracurricular_not_found' => 'No Extracurricular Activity Available.',
        'language_not_found' => 'No Language Proficiency Available.',
        'link_not_found' => 'No Link Account Available.',
        'reference_not_found' => 'No Reference Available.',
        'retired_army_not_found' => 'No Retired Army Employment Available.',
        'portfolio_not_found' => 'No Portfolio Available.',
        'publication_not_found' => 'No Publication Available.',
        'award_not_found' => 'No Award Available.',
        'project_not_found' => 'No Project Available.',
        'other_accomplishment_not_found' => 'No Other Accomplishment Available.',
        'professional_certification' => 'Professional Certification',
        'add_professional_certification' => 'Add Professional Certification',
        'add_experience' => 'Add Experience',
        'job_experiences' => 'Job Experiences',
        'army_experiences' => 'Employment History(For Retired Army Person)',
        ...
        'exam_degree_title' => 'Exam/Degree Title',
        'concentration_major_group' => 'Concentration/ Major/Group',
        'institute_name' => 'Institute Name',
        'scale' => 'Scale',
        'cgpa' => 'CGPA',
        'enter_cgpa' => 'Enter your CGPA',
        'year_of_passing' => 'Year of Passing',
        'enter_year_of_passing' => 'Enter your Year of Passing',
        ...
        'disability_id_not_mentioned' => "You didn't mention your ID yet",
        'career_and_application' => 'Career and Application',
        'career_application_information' => 'Career & Application Information',
        ...
        'or' => 'Or',
        'upload_profile_image_note' => 'Upload your Profile image JPG or PNG, 1MB max',
        'change_user_id' => 'Change User Id',
        'phone_note' => 'Provide at least one Phone Number',
        'email_note' => 'Please enter only one email address in this field',
        'enter_first_name' => 'Enter your first name',
        'enter_last_name' => 'Enter your last name',
        'enter_father_name' => "Enter your father's name",
        'enter_mother_name' => "Enter your mother's name",
        'enter_date_of_birth' => 'Enter your date of birth',
        'enter_nationality' => 'Enter your nationality',
        'enter_national_id_number' => 'Enter your national id number',
        'enter_passport_number' => 'Enter your passport number',
        'enter_passport_issue_date' => 'Enter your passport issue date',
        'enter_phone_number' => 'Enter your Phone number',
        'enter_primary_email' => 'Enter your primary email',
        'enter_alternate_email' => 'Enter your alternate email',
        'enter_emergency_contact' => 'Enter your emergency contact',
        'enter_height' => 'Enter your height',
        'enter_weight' => 'Enter your weight',
        'objective' => 'Objective',
        'objective_help' => 'It is a short summary of your career growth, which should be carefully written to match the job you are applying for.',
        'objective_default' => 'Describe your career objective in short. It should be concise and tailored to the specific job you are applying for.',
        'example' => 'Example',
        'good_example' => 'Good Example',
        'bad_example' => 'Bad Example',
        'good_objective_example' => 'To secure a position with a well-established organization with a stable environment that will lead to a lasting relationship in the field of HealthCare. To obtain a position that will enable the use of my strong organizational skills, Microsoft expertise, and ability to work well with people.',
        'bad_objective_example' => 'My objective is to deliver my best to satisfy my clients. I am dedicated and hard working. I will be very much active to meet the deadlines of your company.',
        'present_salary' => 'Present Salary',
        'enter_current_salary' => 'Enter current salary',
        'expected_salary' => 'Expected Salary',
        'enter_expected_salary' => 'Enter expected salary',
        'taka_month' => 'Taka/Month',
        ...
        'preferred_job_location_help' => 'Preferred Job Location defines the geographical place where you prefer to work. Add your priority wise preferred job locations. i.e. 1st: Dhaka, 2nd: Sylhet, 3rd: Khulna.',
        'inside_bangladesh_districts' => 'Inside Bangladesh: Districts',
        'outside_bangladesh_countries' => 'Outside Bangladesh: Countries',
        'add_districts' => 'Add Districts',
        'add_countries' => 'Add Countries',
        'add_preferred_organization_type' => 'Add your preferred organization type',
        'add_organization_type' => 'Add organization type',
        'career_summary' => 'Career Summary',
        'career_summary_help' => "A section that highlights key skills, achievements, and experience relevant to the job, showing employers you're a strong match for the position.",
        'career_summary_default' => 'Example: A motivated and results-oriented professional with strong communication, problem-solving, and teamwork skills. Seeking an opportunity to utilize my knowledge and experience, contribute to organizational growth, and develop my professional career in a challenging and dynamic environment.',
        'career_summary_placeholder' => 'Example: A motivated and results-oriented professional with strong communication, problem-solving, and teamwork skills. Seeking an opportunity to utilize my knowledge and experience, contribute to organizational growth, and develop my professional career in a challenging and dynamic environment.',
        'enter_writing_texts' => 'Enter your writing texts...',
        'board' => 'Board',
        'select_board' => 'Select your Board',
        'show_summary' => "Show this degree in summary view at employer's end",
        'foreign_institute' => 'This is a foreign institute',
        'training_title' => 'Training Title',
        'enter_training_title' => 'Enter your training title',
        'training_institute' => 'Training Institute',
        'enter_training_institute' => 'Enter your training institute',
        'training_country' => 'Training Country',
        'training_location' => 'Training Location',
        'enter_country' => 'Enter Country',
        'enter_country_name' => 'Enter Country Name',
        'enter_institute' => 'Enter Institute Name',
        'enter_topics_covered' => 'Enter your Topics Covered',
        'training_year' => 'Training Year',
        'enter_training_year' => 'Enter your Training Year',
        'enter_institute_name' => 'Enter Institute name',
        'duration' => 'Duration',
        'enter_duration' => 'Select your duration month',
        'enter_location' => 'Enter location',
        'certification' => 'Certification',
        'enter_certification' => 'Enter your certification',
        'enter_certification_duration' => '31 Dec 2024 - 30 Oct 2025',
        'job_experience' => 'Job Experience',
        'army_experience' => 'Employment History(For Retired Army Person)',
        'skill' => 'Skill',
        ...
        'project' => 'Project',
        'add_skill' => 'Add Skill',
        'add_extracurricular_activities' => 'Add Extracurricular Activities',
        ...
        'select_reading' => 'Select your Reading',
        'select_writing' => 'Select your Writing',
        'select_speaking' => 'Select your Speaking',
        'high' => 'High',
        'medium' => 'Medium',
        'low' => 'Low',
        ...
        'phone_residential' => 'Phone (Residential)',
        'enter_name' => 'Enter your name',
        'enter_email' => 'Enter your email',
        'enter_designation' => 'Enter your designation',
        'enter_organization' => 'Enter your organization',
        'enter_relation' => 'Enter your relation',
        'enter_mobile' => 'Enter your mobile number',
        'enter_phone_office' => 'Enter your Phone (Office)',
        'enter_phone_residential' => 'Enter your Phone (Residential)',
        'address' => 'Address',
        'issued_on' => 'Issued On',
        'enter_title' => 'Enter your title name',
        'enter_url' => 'Enter your URL',
        'you_wrote' => 'You wrote',
        'characters' => 'character(s)',
        'how_did_you_learn_skill' => 'How did you learn the skill?',
        'enter_skill' => 'Enter your skill',
        'self' => 'Self',
        'job' => 'Job',
        'educational' => 'Educational',
        'professional_training' => 'Professional Training',
        'ntvqf' => 'NTVQF',
        'confirm_delete_extracurricular' => 'Are you sure you want to delete this extracurricular activity?',
        'confirm_delete_language' => 'Are you sure you want to delete this language?',
        'confirm_delete_link_account' => 'Are you sure you want to delete this link account?',
        'confirm_delete_reference' => 'Are you sure you want to delete this reference?',
        ...
        'confirm_delete_award' => 'Are you sure you want to delete this award?',
        'confirm_delete_project' => 'Are you sure you want to delete this project?',
        'confirm_delete_other_accomplishment' => 'Are you sure you want to delete this other accomplishment?',
        'max_2' => '(max 2)',
        'max_5' => '(max 5)',
        'other_accomplishment' => 'Other Accomplishment',
        'company_name' => 'Company Name',
        'enter_company_name' => 'Enter Company Name',
        'company_business' => 'Company Business',
        'enter_company_business' => 'Enter Company Business',
        'department' => 'Department',
        'enter_department' => 'Enter Department',
        'employment_period' => 'Employment Period',
        'employment_period_start_date' => 'Employment Period Start Date',
        'employment_period_end_date' => 'Employment Period End Date',
        'responsibility' => 'Responsibility',
        'enter_responsibility' => 'Enter Responsibility',
        'company_location' => 'Company Location',
        'enter_company_location' => 'Enter Company location',
        'area_of_expertise' => 'Area of Expertise',
        'add_area_of_expertise_help' => 'Add your area of expertise with duration (max 10)',
        'month_s' => 'Month(s)',
        'add_new' => 'Add New',
        'remove_expertise' => 'Remove expertise',
        'information' => 'Information',
        'ba_no' => 'BA No',
        'select_ba_no' => 'Select your BA no',
        'enter_ba_no' => 'Enter your Ba No',
        'ranks' => 'Ranks',
        'enter_rank' => 'Enter your Rank',
        'type' => 'Type',
        'enter_type' => 'Enter your Type',
        'arms' => 'Arms',
        'trade' => 'Trade',
        'course' => 'Course',
        ...
        'special_qualification_help' => 'A short 3-5 sentence summary of your key experience, strengths, and personal qualities.',
        'special_qualification_default' => "Example:\n1. Full stack laravel developer (ReactJs & Laravel)\n2. Computer Basic and ICT Application Course from DYD\n3. Shorthand Course",
        'special_qualification_placeholder' => "Example:\n1. Full stack laravel developer (ReactJs & Laravel)\n2. Computer Basic and ICT Application Course from DYD\n3. Shorthand Course",
        'keywords' => 'Keywords',
        'keywords_help' => 'Specific terms related to skills, qualifications, or institutions used by job seekers and employers to find better matches. Examples: MBA, Java, HTML, BUET, NSU.',
        'keywords_default' => 'Example: Full stack laravel developer',
        'keywords_placeholder' => 'Example: Full stack laravel developer',
        'have_disability_id_number' => 'Do you have National Disability ID Number?',
        'national_disability_id' => 'National Disability ID',
        'show_on_profile' => 'Show on Profile',
        'select_your_difficulty' => 'Select your Difficulty',
        'no_difficulty' => 'No difficulty',
        'some_difficulty' => 'Some difficulty',
        'a_lot_of_difficulty' => 'A lot of difficulty',
        'yes_some_difficulties' => 'Yes - some difficulties',
        'yes_lot_of_difficulties' => 'Yes - a lot of difficulties',
        'cannot_do' => 'Cannot do at all',
        'difficulty_to_see' => 'Difficulty to See',
        'difficulty_to_hear' => 'Difficulty to Hear',
        'difficulty_to_concentrate_or_remember' => 'Difficulty to Concentrate or Remember',
        'difficulty_to_sit_stand_walk' => 'Difficulty to Sit, Stand, Walk or Climb Stairs',
        'difficulty_to_communicate' => 'Difficulty to Communicate',
        'difficulty_of_taking_care' => 'Difficulty of Taking Care (e.g. shower, dressing)',
        'disability_support_prefix' => 'If you are a person with disability and have no Disability ID Number, please contact',
        'disability_support_contact' => 'i2i support +8801730369802',
        'disability_support_suffix' => 'by Call/ SMS/ WhatsApp.',
        ...
        'application_cv_default_help' => 'Keep the CV generated from your profile selected by default.',
        'uploaded_cv' => 'This uploaded CV',
        'uploaded_cv_default_help' => 'Select the CV you are uploading for future job applications.',
        'generated' => 'Generated',
        'selected' => 'Selected',
        'application_cv_delete_error' => 'The generated Default CV cannot be deleted.',
        'default_cv_updated' => 'The selected CV has been updated successfully.',
        'resume_upload_limit' => 'You can upload only one additional CV. Delete the existing uploaded CV before adding another one.',
        'resume_preview_unavailable' => 'This file format cannot be previewed in the browser.',
    ],
    'apply_job' => [
        'apply_job' => 'Apply Job',
        'resume' => 'Resume',
        ...
        'application_details_help' => 'Review your information before submitting the application.',
        'choose_cv' => 'Choose a CV',
        'selected_cv' => 'Selected CV',
        'selected_for_application' => 'This CV will be sent with your application.',
        'preview_cv' => 'Preview',
        'default_cv' => 'Default CV',
        'expected_salary_hint' => 'Enter your expected monthly salary.',
        'notes_placeholder' => 'Write a short note for the employer (optional)',
    ],
    'job_application' => [
        'candidate_name' => 'Candidate Name',
    ...
    'plan' => [
        ...
        'pay_with_stack' => 'Pay with PayStack',
        'upgrade' => 'Upgrade',
        'plan' => 'Plan',
    ...
    'notification_settings' => [
        ...
        'JOB_EXPIRY_ALERT' => 'When job deadlines are today, tomorrow, or in 7 days',
    ...
    'ad' => [
        ...
        'media_help' => 'Supported Format: JPG, PNG, WEBP, SVG, MP4, WEBM, OGG. Maximum size: 50 MB.',
        'media_extension_message' => 'The media must be a file of type: jpeg, jpg, png, webp, svg, mp4, webm, ogg.',
        'media_size_message' => 'The media may not be greater than 50 MB.',
        'invalid_svg_message' => 'The SVG file is invalid or contains unsafe content.',
        'uploading' => 'Uploading',
        'saving_media' => 'Saving media...',
        ...
        'page_required' => 'Target Page is required.',
        'pages' => [
            'all' => 'All Pages',
            'candidate_register' => 'Candidate Register Page',
            'employer_register' => 'Employer Register Page',
            'candidate_login' => 'Candidate Login Page',
            'employer_login' => 'Employer Login Page',
            'home' => 'Home Page',
            'blog' => 'Blog Page',
    ...
    'state' => [
        'states' => 'Divisions',
        'new_state' => 'New Division',
        'edit_state' => 'Edit Division',
        'state_name' => 'Division Name',
        'country_name' => 'Country Name',
        'no_state_found' => 'No Division Found',
        'no_state_available' => 'No Division Available',
    ],
    'city' => [
        'cities' => 'Districts',
        'new_city' => 'New District',
        'edit_city' => 'Edit District',
        'city_name' => 'District Name',
        'state_name' => 'Division',
        'no_city_found' => 'No District Found',
        'no_city_available' => 'No District Available',
    ],
    'city_village' => [
        'city_villages' => 'City/Villages',
        'new_city_village' => 'New City/Village',
        'edit_city_village' => 'Edit City/Village',
        'city_village_name' => 'City/Village Name',
        'no_city_village_found' => 'No City/Village Found',
        'no_city_village_available' => 'No City/Village Available',
    ],
    'thana' => [
        'thanas' => 'Thanas',
        ...
        'city_name' => 'District',
        'no_thana_found' => 'No Thana Found',
        'no_thana_available' => 'No Thana Available',
    ],
    'job_notification' => [
    ...
    'flash' => [
        ...
        'job_save_pending_approval' => 'Job submitted successfully. Our team will review and approve it within 24 hours.',
        ...
        'candidate_training_save' => 'Candidate Training added successfully.',
        'candidate_training_retrieved' => 'Candidate Training retrieved successfully.',
        'candidate_training_update' => 'Candidate Training updated successfully.',
        'candidate_training_delete' => 'Candidate Training deleted successfully.',
        'candidate_retired_army_employment_update' => 'Retired Army Experience updated successfully.',
        'candidate_retired_army_employment_delete' => 'Retired Army Experience deleted successfully.',
        'brand_save' => 'Brand saved successfully.',
        'ad_save' => 'Ad saved successfully.',
        'ad_update' => 'Ad updated successfully.',
        'ad_delete' => 'Ad deleted successfully.',
        'ad_retrieved' => 'Ad retrieved successfully.',
        ...
        'city_save' => 'District saved successfully.',
        'city_retrieved' => 'District retrieved successfully.',
        'city_update' => 'District updated successfully.',
        'city_delete' => 'District deleted successfully.',
        'city_cant_delete' => 'District can\'t be deleted.',
        'city_village_save' => 'City/Village saved successfully.',
        'city_village_retrieved' => 'City/Village retrieved successfully.',
        'city_village_update' => 'City/Village updated successfully.',
        'city_village_delete' => 'City/Village deleted successfully.',
        'city_village_cant_delete' => 'City/Village can\'t be deleted.',
        'thana_save' => 'Thana saved successfully.',
        'thana_retrieved' => 'Thana retrieved successfully.',
        'thana_update' => 'Thana updated successfully.',
        'thana_delete' => 'Thana deleted successfully.',
        'thana_cant_delete' => 'Thana can\'t be deleted.',
        ...
        'job_application_draft_not_found' => 'This job application draft no longer exists.',
        ...
        'job_application_archive' => 'Job Application removed from your list successfully.',
        'job_application_restore' => 'Job Application restored successfully.',
        ...
        'job_already_featured' => 'Job is already featured.',
        'job_not_featured' => 'Job is not featured.',
        ...
        'this_currency_is_not' => 'This currency is not supported by PayStack for making payments.',
        ...
        'state_save' => 'Division saved successfully.',
        'state_update' => 'Division updated successfully.',
        'state_delete' => 'Division deleted successfully.',
        'state_cant_delete' => 'Division cannot be deleted.',
        ...
        'register_success_mail_active' => 'You have registered successfully.',
    ...
    'front_job_details' => [
        ...
        'discard_draft_confirmation' => 'Are you sure you want to discard this application draft?',
    ...
    'pending_jobs' => [
        ...
        'closed' => 'Closed',
        'pending' => 'Pending',
        'successfully_accepted' => 'Job has been accepted successfully.',
        'successfully_reject' => 'Job has been rejected successfully.',
        'reason' => 'Reason',
        'suspended' => 'Suspended',
        'unlimited_plan' => 'Unlimited Plan',
    ],
    'employer_account' => [
        'company_details_information' => 'Company Details Information',
        'company_name' => 'Company Name',
        'company_name_bn' => 'Company Name (in Bangla)',
        'company_name_bn_placeholder' => 'Type Company Name in Bangla',
        'year_of_establishment' => 'Year of Establishment',
        'number_of_employees' => 'Number of Employees',
        'company_address' => 'Company Address',
        'company_address_bn' => 'Company Address (in Bangla)',
        'company_summary_placeholder' => 'Write a short company summary',
        'company_summary_bn_placeholder' => 'Write a short company summary in Bangla',
        'all' => 'All',
        'industry_type' => 'Industry Type',
        'add_new_industry' => 'Add a New Industry',
        'search_industry' => 'Search Industry',
        'no_industry_found_category' => 'No industry found in this category.',
        'see_more' => 'See more',
        'business_description' => 'Business Description',
        'trade_license_no' => 'Business/ Trade License No',
        'enter_trade_license_no' => 'Enter Trade License No',
        'rl_no' => 'RL No.',
        'rl_no_only_recruiting_agency' => 'Only for Recruiting Agency',
        ...
        'contact_person_mobile' => "Contact Person's Mobile",
        'add_edit_contact_person' => 'Edit Contact Person',
        ...
        'has_disability_facilities_question' => 'Does your company have facilities for person with disabilities?',
        'learn_more_about_disability' => 'Learn more about disability facilities',
        'learn_more' => 'Learn more',
        'yes' => 'Yes',
        'no' => 'No',
        'facilities_text' => 'Facilities for person with Disabilities here.',
        'disability_inclusion_policy' => 'Do you have Disability Inclusion Policy',
        'disability_support' => 'Would you like to have any support for implementing?',
        'disability_training' => 'Do you provide Disability Inclusion Training for your Employees?',
        'disability_facilities_question' => 'As part of Disability Inclusion, what do your company have?',
        'save_changes' => 'Save Changes',
        'change_password_help' => 'You can change your password from here. But make sure to choose a password that you can remember',
        'old_password' => 'Old Password',
        'enter_old_password' => 'Enter old password',
        'show_old_password' => 'Show old password',
        'new_password' => 'New Password',
        ...
        'specify_industry' => 'Please specify your industry',
        'your_industry_name' => 'Your Industry Name',
        'type_industry_name' => 'Type industry name',
        'add' => 'Add',
        'close' => 'Close',
    ],
    'employer_register' => [
        'user_information_title' => "Let's Start by Filling Out Your User Information",
        'username' => 'Username',
        'username_placeholder' => 'Type Username',
        'password' => 'Password',
        'password_placeholder' => 'Use 6 to 20 characters',
        'confirm_password' => 'Confirm Password',
        'confirm_password_placeholder' => 'Retype password',
        'company_information_title' => 'Tell Us About Your Company',
        'company_name' => 'Company Name',
        'company_name_placeholder' => 'Type Company Name',
        'company_name_bn' => 'Company Name (in Bangla)',
        'company_name_bn_placeholder' => 'Type Company Name',
        'year_of_establishment' => 'Year of Establishment',
        'year_of_establishment_placeholder' => "Type Company's Establishment Year",
        'number_of_employees' => 'Number of Employees',
        'company_address' => 'Company Address',
        'select_district' => 'Select District',
        'select_thana' => 'Select Thana',
        'company_address_en_placeholder' => 'Write Company Detail Address In English',
        'company_address_bn_placeholder' => 'Write Company Detail Address In Bangla',
        'industry_type' => 'Industry Type',
        'all' => 'All',
        'add_new_industry' => 'Add a New Industry',
        'search_industry' => 'Search Industry',
        ...
        'see_more' => 'See more',
        'business_description' => 'Business Description',
        'business_description_placeholder' => 'Write Business Description',
        'trade_license_no' => 'Business/ Trade License No',
        'trade_license_no_placeholder' => 'Business/ Trade License No',
        'rl_no' => 'RL No.',
        'rl_no_only_recruiting_agency' => 'Only for Recruiting Agency',
        'enter_number_only' => 'Enter Number Only',
        'website_url' => 'Website URL',
        'website_url_placeholder' => 'Type Website URL',
        'contact_information_title' => 'Provide Contact Person Information',
        'contact_person_name' => "Contact Person's Name",
        'contact_person_name_placeholder' => "Type contact person's name",
        'contact_person_designation' => "Contact Person's Designation",
        'contact_person_designation_placeholder' => "Type contact person's designation",
        'contact_person_email' => "Contact Person's Email",
        'contact_person_email_placeholder' => "Type contact person's email",
        'contact_person_mobile' => "Contact Person's Mobile",
        'enter_mobile_number' => 'Enter Mobile Number',
        'accessibility_title' => 'Accessibility Profile for Inclusion of Persons with Disabilities',
        'enable_facilities' => 'Enable Facilities for Person with Disabilities as Employees',
        'learn_more' => 'Learn More',
        'disability_inclusion_policy' => 'Do you have Disability Inclusion Policy',
        'yes' => 'Yes',
        'no' => 'No',
