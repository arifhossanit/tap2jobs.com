<div id="addStateModal" class="modal fade" role="dialog" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class=" mb-5">
                    ...
                    <span class="required"></span>
                    {{ Form::textarea('name', null, ['id'=>'stateName','class' => 'form-control','required','rows' => 3,'placeholder' => 'Enter name or multiple names (separated by commas or new lines)']) }}
                </div>
