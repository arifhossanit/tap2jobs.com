<div class="row">
    ...
    <div class="col-xl-6 col-md-6 col-sm-12 mb-5">
        ...
        <span class="required"></span>
        {{ Form::select('jobCategory[]', $data['jobCategory'], old('jobCategory', $data['jobCategories'] ?? [$job->job_category_id]), ['id' => 'jobCategoryId', 'class' => 'form-select io-select2', 'data-control' => 'select2', 'data-placeholder' => __('messages.company.select_job_category'), 'required', 'multiple' => true]) }}
