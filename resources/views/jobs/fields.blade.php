<div class="row">
    ...
    <div class="col-xl-6 col-md-6 col-sm-12 mb-5">
        ...
        <div class="input-group">
            ...
            <input type="text" name="job_expiry_date" id="availableAt"
                   ...
                   autocomplete="off" required value="{{ old('job_expiry_date') }}"
    ...
    <div class="col-xl-1 col-md-1 col-sm-12 mb-5">
        ...
        <label class="form-check form-switch form-switch-sm {{ checkLanguageSession() == 'ar' ? 'float-end' : 'float-start' }}">
            <input type="checkbox" name="hide_salary" class="form-check-input" value="1"
                   id="salary" {{ old('hide_salary') ? 'checked' : '' }}>
        </label>
    </div>
    <div class="col-xl-6 col-md-6 col-sm-12 mb-5">
    ...
    <div class="col-xl-6 col-md-6 col-sm-12 mb-5">
        ...
        <span class="required"></span>
        {{ Form::select('currency_id', $data['currencies'], old('currency_id', $data['default_job_currency_id'] ?? null), ['id' => 'currencyId', 'class' => 'form-select', 'placeholder' => __('messages.company.select_currency'), 'data-control' => 'select2', 'required']) }}
    </div>
    <div class="col-xl-6 col-md-6 col-sm-12 mb-5">
    ...
    <div class="col-xl-6 col-md-6 col-sm-12 mb-5">
        ...
        {{ Form::select('career_level_id', $data['careerLevels'], null, ['id' => 'careerLevelsId', 'class' => 'form-select', 'placeholder' => __('messages.company.select_career_level')]) }}
    </div>
    <div class="col-xl-6 col-md-6 col-sm-12 mb-5">
