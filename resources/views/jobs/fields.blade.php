<div class="row">
    ...
    <div class="col-xl-6 col-md-6 col-sm-12 mb-5">
        ...
        <span class="required"></span>
        {{ Form::select('currency_id', $data['currencies'], null, ['id' => 'currencyId', 'class' => 'form-select', 'placeholder' => __('messages.company.select_currency'), 'data-control' => 'select2', 'required']) }}
    </div>
    <div class="col-xl-6 col-md-6 col-sm-12 mb-5">
