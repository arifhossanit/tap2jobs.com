        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mb-5">
                    ...
                    {{ Form::textarea('search_tags', null, ['class' => 'form-control job-category-search-tags', 'id' => 'addJobCategorySearchTags', 'rows' => 3, 'placeholder' => 'Type or paste comma-separated tags']) }}
