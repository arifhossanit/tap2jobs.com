<div id="addProfileReferenceOptionModal" class="modal fade" role="dialog" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">New Profile Reference</h3>
                <button type="button" aria-label="Close" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            {{ Form::open(['id'=>'addProfileReferenceOptionForm']) }}
            <div class="modal-body">
                <div class="alert alert-danger fs-4 text-white d-flex align-items-center d-none" id="profileReferenceOptionValidationErrorsBox">
                ...
                <div class="mb-5">
                    ...
                    {{ Form::text('value', null, ['id'=>'profileReferenceValue', 'class' => 'form-control', 'placeholder' => 'Leave blank to use name']) }}
                </div>
                <div class="mb-5">
            ...
            <div class="modal-footer pt-0">
                {{ Form::button(__('messages.common.save'), ['type' => 'submit', 'class' => 'btn btn-primary m-0', 'id' => 'profileReferenceOptionBtnSave', 'data-loading-text' => "<span class='spinner-border spinner-border-sm'></span> ".__('messages.common.process')]) }}
