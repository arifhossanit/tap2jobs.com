...
<div class="job-desc-right br-10 px-40 bg-light mb-40">
    <div class="pb-2">
        <div class="desc-box d-flex justify-content-between mb-4">
            <div class="desc d-flex">
                <div class="{{ getFrontSelectLanguage() == 'ar' ? 'ms-2' : 'me-2' }} w-20">
                    <i class="fa-solid fa-graduation-cap fa-fw fs-5" style="color: #209776;"></i>
            ...
            <p class="fs-14 text-gray text-end mb-0">
                {{ $candidateEducations->first()?->degreeLevel?->name ?: __('messages.n/a') }}
            </p>
        </div>
        <div class="desc-box d-flex justify-content-between mb-4">
            <div class="desc d-flex">
                <div class="{{ getFrontSelectLanguage() == 'ar' ? 'ms-2' : 'me-2' }} w-20">
                    <i class="fa-solid fa-wallet fa-fw fs-5" style="color: #209776;"></i>
                    <svg class="d-none" width="20" height="20" viewBox="0 0 20 20" fill="none"
        ...
        <div class="desc-box d-flex justify-content-between mb-4">
            <div class="desc d-flex">
                <div class="{{ getFrontSelectLanguage() == 'ar' ? 'ms-2' : 'me-2' }} w-20">
                    <i class="fa-solid fa-money-bill-trend-up fa-fw fs-5" style="color: #209776;"></i>
                    <svg class="d-none" width="20" height="20" viewBox="0 0 20 20" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <g clip-path="url(#clip0_1043_525)">
                            <path
        ...
        <div class="desc-box d-flex justify-content-between mb-4">
            <div class="desc d-flex">
                <div class="{{ getFrontSelectLanguage() == 'ar' ? 'ms-2' : 'me-2' }} d-flex w-20">
                    <i class="fa-solid fa-venus-mars fa-fw fs-5" style="color: #209776;"></i>
                    <svg class="d-none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" style="color: rgb(25, 103, 210)"
