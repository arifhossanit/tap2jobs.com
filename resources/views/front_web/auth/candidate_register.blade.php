                                ...
                                <div class="col-12 mb-4">
                                    <div class="form-group row">
                                        <div class="col-sm-6 col-12 mb-3 mb-sm-0">
                                            <a href="{{ route('candidate.register') }}" class="btn btn-primary  d-block">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-md-4 mb-3 ">
                                        ...
                                        <input type="text" class="form-control fs-14 text-gray bg-white  br-10 p-3"
                                            name="first_name" id="candidateFirstName"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-md-4 mb-3 ">
                                        <label for=""
                                            ...
                                            <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control fs-14 text-gray bg-white  br-10 p-3"
                                            name="last_name" id="candidateLastName"
                                            placeholder="{{ __('web.register_menu.enter_last_name') }}" required>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group mb-md-4 mb-3 ">
                                        ...
                                        <input type="email" class="form-control fs-14 text-gray bg-white  br-10 p-3"
                                            name="email" id="candidateEmail"
                                            placeholder="{{ __('web.register_menu.enter_email_address') }}" required>
                                    </div>
                                </div>
                                <div class="col-md-6 position-relative">
                                    <div class="form-group mb-md-4 mb-3 ">
                                        ...
                                        <input type="password" class="form-control fs-14 text-gray bg-white  br-10 p-3"
                                            name="password" id="candidatePassword"
                                            placeholder="{{ __('web.register_menu.enter_password') }}" required
                                ...
                                <div class="col-md-6 position-relative">
                                    <div class="form-group mb-md-4 mb-3 ">
                                        ...
                                        <input type="password" class="form-control fs-14 text-gray bg-white  br-10 p-3"
                                            ...
                                            placeholder="{{ __('web.register_menu.confirm_password') }}" required
                                            onkeypress="return avoidSpace(event)">
                                        <span
                                            class="position-absolute d-flex align-items-center top-1 bottom-0 {{ getFrontSelectLanguage() == 'ar' ? 'start-0' : 'end-0' }} me-6 input-icon input-password-hide cursor-pointer text-gray-600 change-type change-type-register ">
                                            <i class="fas fa-eye-slash"></i>
                            ...
                            <div class="col-12">
                                <div class="d-grid">
                                    ...
                                    @if (
                                        ...
                                        <a href="{{ url('/login/linkedin-openid?type=1') }}"
