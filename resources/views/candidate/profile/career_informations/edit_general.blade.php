...
<div class="row">
    ...
    <div class="col-sm-12 mb-5">
        ...
        <span class="required"></span>
        {{ Form::select('candidateSkills[]', $data['skills'], count($candidateSkills) > 0 ? $candidateSkills : null, ['class' => 'form-select ', 'id' => 'cvSkillId', 'multiple' => true, 'required']) }}
    ...
    <div class="col-sm-12 mb-5">
        ...
        <span class="required"></span>
        {{ Form::select('country_id', $data['countries'], null, ['id' => 'candidateCountryId', 'class' => 'form-select io-select2', 'data-control' => 'select2', 'placeholder' => __('messages.company.select_country'), 'required']) }}
    </div>
    <div class="col-sm-12 mb-5">
        {{ Form::label('state', __('messages.company.state') . ':', ['class' => 'form-label']) }}
        {{ Form::select('state_id', [], null, ['id' => 'candidateStateId', 'class' => 'form-select io-select2', 'data-control' => 'select2', 'placeholder' => __('messages.company.select_state')]) }}
    </div>
    <div class="col-sm-12 mb-5">
        {{ Form::label('city', __('messages.company.city') . ':', ['class' => 'form-label']) }}
        {{ Form::select('city_id', [], null, ['id' => 'candidateCityId', 'class' => 'form-select io-select2', 'data-control' => 'select2', 'placeholder' => __('messages.company.select_city')]) }}
    </div>
</div>
