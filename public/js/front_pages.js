  ...
  $.ajax({
    ...
    success: function success(result) {
      if (result.success) {
        ...
        $('.modal-backdrop').remove(); // $(".reportToCompanyBtn").attr("style", "pointer-events:none;");
...
document.addEventListener('DOMContentLoaded', loadPhoneNumberCountry); // document.addEventListener('DOMContentLoaded', loadPhoneNumberCountry);
...
listenClick('.delete-comment-btn', function (event) {
  ...
  swal((_swal = {
    ...
    closeOnConfirm: false,
    showLoaderOnConfirm: true
  }, _defineProperty(_swal, "showCancelButton", true), _defineProperty(_swal, "confirmButtonText", Lang.get('js.ok')), _defineProperty(_swal, "cancelButtonText", Lang.get('js.cancel')), _defineProperty(_swal, "confirmButtonColor", '#1967d2'), _defineProperty(_swal, "cancelButtonColor", '#d33'), _swal), function (isConfirmed) {
    if (isConfirmed) {
      $.ajaxSetup({
        headers: {
